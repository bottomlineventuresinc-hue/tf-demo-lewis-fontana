/* Template Factory - Gregory Lewis Plumbing live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-lewis-fontana/';
  var LS_CHANGES = 'tf_lewis_change_log_v1';
  var LS_PURCHASED = 'tf_lewis_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Gregory at Gregory Lewis Plumbing. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Gregory at Gregory Lewis Plumbing. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Gregory Lewis Plumbing. Hang tight.',
        delay,
        function () {
